...
func eventItems() []itemDef {
	return []itemDef{
		...
		{"EVT-MIX-001", "Cocktail Mixology Workshop", "Craft signature cocktails with our expert bartender", "events", entitem.TypeSERVICE, "TICKET", imgCocktail, 0, []string{"event"}, nil},
		{"EVT-QUZ-001", "Monthly Quiz Night", "Monthly trivia night with prizes and two-course dinner", "events", entitem.TypeSERVICE, "TICKET", imgMain1, 0, []string{"event"}, nil},
	}
}
