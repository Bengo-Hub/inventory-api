...
func (c *Client) init() {
	...
	c.StockClearance = NewStockClearanceClient(c.config)
	c.StockCount = NewStockCountClient(c.config)
	c.StockCountLine = NewStockCountLineClient(c.config)
	c.StockCountTemplate = NewStockCountTemplateClient(c.config)
	...
	c.VendorBalanceCache = NewVendorBalanceCacheClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		StockClearance:         NewStockClearanceClient(cfg),
		StockCount:             NewStockCountClient(cfg),
		StockCountLine:         NewStockCountLineClient(cfg),
		StockCountTemplate:     NewStockCountTemplateClient(cfg),
		...
		VendorBalanceCache:     NewVendorBalanceCacheClient(cfg),
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.StockClearance, c.StockCount, c.StockCountLine, c.StockCountTemplate,
		c.StockLevelEvent, c.StockTransfer, c.StockTransferLine, c.Supplier,
		c.SupplierPerformance, c.SupplierResponse, c.Tenant, c.TenantInventoryConfig,
		c.Ticket, c.Unit, c.UserOutlet, c.UserRoleAssignment, c.VariantAttribute,
		c.VendorBalanceCache, c.Warehouse, c.WarehouseLocation, c.Warranty,
	} {
		n.Use(hooks...)
	}
}
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *StockClearanceMutation:
		return c.StockClearance.mutate(ctx, m)
	case *StockCountMutation:
		return c.StockCount.mutate(ctx, m)
	case *StockCountLineMutation:
		return c.StockCountLine.mutate(ctx, m)
	case *StockCountTemplateMutation:
		return c.StockCountTemplate.mutate(ctx, m)
	...
	case *VendorBalanceCacheMutation:
		return c.VendorBalanceCache.mutate(ctx, m)
...
// StockClearanceClient is a client for the StockClearance schema.
type StockClearanceClient struct {
	config
}

// NewStockClearanceClient returns a client for the StockClearance from the given config.
func NewStockClearanceClient(c config) *StockClearanceClient {
	return &StockClearanceClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `stockclearance.Hooks(f(g(h())))`.
func (c *StockClearanceClient) Use(hooks ...Hook) {
	c.hooks.StockClearance = append(c.hooks.StockClearance, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `stockclearance.Intercept(f(g(h())))`.
func (c *StockClearanceClient) Intercept(interceptors ...Interceptor) {
	c.inters.StockClearance = append(c.inters.StockClearance, interceptors...)
}

// Create returns a builder for creating a StockClearance entity.
func (c *StockClearanceClient) Create() *StockClearanceCreate {
	mutation := newStockClearanceMutation(c.config, OpCreate)
	return &StockClearanceCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of StockClearance entities.
func (c *StockClearanceClient) CreateBulk(builders ...*StockClearanceCreate) *StockClearanceCreateBulk {
	return &StockClearanceCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *StockClearanceClient) MapCreateBulk(slice any, setFunc func(*StockClearanceCreate, int)) *StockClearanceCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &StockClearanceCreateBulk{err: fmt.Errorf("calling to StockClearanceClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*StockClearanceCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for StockClearance.
func (c *StockClearanceClient) Update() *StockClearanceUpdate {
	mutation := newStockClearanceMutation(c.config, OpUpdate)
	return &StockClearanceUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *StockClearanceClient) UpdateOne(_m *StockClearance) *StockClearanceUpdateOne {
	mutation := newStockClearanceMutation(c.config, OpUpdateOne, withStockClearance(_m))
	return &StockClearanceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *StockClearanceClient) UpdateOneID(id uuid.UUID) *StockClearanceUpdateOne {
	mutation := newStockClearanceMutation(c.config, OpUpdateOne, withStockClearanceID(id))
	return &StockClearanceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for StockClearance.
func (c *StockClearanceClient) Delete() *StockClearanceDelete {
	mutation := newStockClearanceMutation(c.config, OpDelete)
	return &StockClearanceDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *StockClearanceClient) DeleteOne(_m *StockClearance) *StockClearanceDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *StockClearanceClient) DeleteOneID(id uuid.UUID) *StockClearanceDeleteOne {
	builder := c.Delete().Where(stockclearance.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &StockClearanceDeleteOne{builder}
}

// Query returns a query builder for StockClearance.
func (c *StockClearanceClient) Query() *StockClearanceQuery {
	return &StockClearanceQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeStockClearance},
		inters: c.Interceptors(),
	}
}

// Get returns a StockClearance entity by its id.
func (c *StockClearanceClient) Get(ctx context.Context, id uuid.UUID) (*StockClearance, error) {
	return c.Query().Where(stockclearance.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *StockClearanceClient) GetX(ctx context.Context, id uuid.UUID) *StockClearance {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *StockClearanceClient) Hooks() []Hook {
	return c.hooks.StockClearance
}

// Interceptors returns the client interceptors.
func (c *StockClearanceClient) Interceptors() []Interceptor {
	return c.inters.StockClearance
}

func (c *StockClearanceClient) mutate(ctx context.Context, m *StockClearanceMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&StockClearanceCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&StockClearanceUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&StockClearanceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&StockClearanceDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown StockClearance mutation op: %q", m.Op())
	}
}
...
// StockCountTemplateClient is a client for the StockCountTemplate schema.
type StockCountTemplateClient struct {
	config
}

// NewStockCountTemplateClient returns a client for the StockCountTemplate from the given config.
func NewStockCountTemplateClient(c config) *StockCountTemplateClient {
	return &StockCountTemplateClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `stockcounttemplate.Hooks(f(g(h())))`.
func (c *StockCountTemplateClient) Use(hooks ...Hook) {
	c.hooks.StockCountTemplate = append(c.hooks.StockCountTemplate, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `stockcounttemplate.Intercept(f(g(h())))`.
func (c *StockCountTemplateClient) Intercept(interceptors ...Interceptor) {
	c.inters.StockCountTemplate = append(c.inters.StockCountTemplate, interceptors...)
}

// Create returns a builder for creating a StockCountTemplate entity.
func (c *StockCountTemplateClient) Create() *StockCountTemplateCreate {
	mutation := newStockCountTemplateMutation(c.config, OpCreate)
	return &StockCountTemplateCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of StockCountTemplate entities.
func (c *StockCountTemplateClient) CreateBulk(builders ...*StockCountTemplateCreate) *StockCountTemplateCreateBulk {
	return &StockCountTemplateCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *StockCountTemplateClient) MapCreateBulk(slice any, setFunc func(*StockCountTemplateCreate, int)) *StockCountTemplateCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &StockCountTemplateCreateBulk{err: fmt.Errorf("calling to StockCountTemplateClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*StockCountTemplateCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for StockCountTemplate.
func (c *StockCountTemplateClient) Update() *StockCountTemplateUpdate {
	mutation := newStockCountTemplateMutation(c.config, OpUpdate)
	return &StockCountTemplateUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *StockCountTemplateClient) UpdateOne(_m *StockCountTemplate) *StockCountTemplateUpdateOne {
	mutation := newStockCountTemplateMutation(c.config, OpUpdateOne, withStockCountTemplate(_m))
	return &StockCountTemplateUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *StockCountTemplateClient) UpdateOneID(id uuid.UUID) *StockCountTemplateUpdateOne {
	mutation := newStockCountTemplateMutation(c.config, OpUpdateOne, withStockCountTemplateID(id))
	return &StockCountTemplateUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for StockCountTemplate.
func (c *StockCountTemplateClient) Delete() *StockCountTemplateDelete {
	mutation := newStockCountTemplateMutation(c.config, OpDelete)
	return &StockCountTemplateDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *StockCountTemplateClient) DeleteOne(_m *StockCountTemplate) *StockCountTemplateDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *StockCountTemplateClient) DeleteOneID(id uuid.UUID) *StockCountTemplateDeleteOne {
	builder := c.Delete().Where(stockcounttemplate.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &StockCountTemplateDeleteOne{builder}
}

// Query returns a query builder for StockCountTemplate.
func (c *StockCountTemplateClient) Query() *StockCountTemplateQuery {
	return &StockCountTemplateQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeStockCountTemplate},
		inters: c.Interceptors(),
	}
}

// Get returns a StockCountTemplate entity by its id.
func (c *StockCountTemplateClient) Get(ctx context.Context, id uuid.UUID) (*StockCountTemplate, error) {
	return c.Query().Where(stockcounttemplate.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *StockCountTemplateClient) GetX(ctx context.Context, id uuid.UUID) *StockCountTemplate {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *StockCountTemplateClient) Hooks() []Hook {
	return c.hooks.StockCountTemplate
}

// Interceptors returns the client interceptors.
func (c *StockCountTemplateClient) Interceptors() []Interceptor {
	return c.inters.StockCountTemplate
}

func (c *StockCountTemplateClient) mutate(ctx context.Context, m *StockCountTemplateMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&StockCountTemplateCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&StockCountTemplateUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&StockCountTemplateUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&StockCountTemplateDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown StockCountTemplate mutation op: %q", m.Op())
	}
}
...
// VendorBalanceCacheClient is a client for the VendorBalanceCache schema.
type VendorBalanceCacheClient struct {
	config
}

// NewVendorBalanceCacheClient returns a client for the VendorBalanceCache from the given config.
func NewVendorBalanceCacheClient(c config) *VendorBalanceCacheClient {
	return &VendorBalanceCacheClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `vendorbalancecache.Hooks(f(g(h())))`.
func (c *VendorBalanceCacheClient) Use(hooks ...Hook) {
	c.hooks.VendorBalanceCache = append(c.hooks.VendorBalanceCache, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `vendorbalancecache.Intercept(f(g(h())))`.
func (c *VendorBalanceCacheClient) Intercept(interceptors ...Interceptor) {
	c.inters.VendorBalanceCache = append(c.inters.VendorBalanceCache, interceptors...)
}

// Create returns a builder for creating a VendorBalanceCache entity.
func (c *VendorBalanceCacheClient) Create() *VendorBalanceCacheCreate {
	mutation := newVendorBalanceCacheMutation(c.config, OpCreate)
	return &VendorBalanceCacheCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of VendorBalanceCache entities.
func (c *VendorBalanceCacheClient) CreateBulk(builders ...*VendorBalanceCacheCreate) *VendorBalanceCacheCreateBulk {
	return &VendorBalanceCacheCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *VendorBalanceCacheClient) MapCreateBulk(slice any, setFunc func(*VendorBalanceCacheCreate, int)) *VendorBalanceCacheCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &VendorBalanceCacheCreateBulk{err: fmt.Errorf("calling to VendorBalanceCacheClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*VendorBalanceCacheCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for VendorBalanceCache.
func (c *VendorBalanceCacheClient) Update() *VendorBalanceCacheUpdate {
	mutation := newVendorBalanceCacheMutation(c.config, OpUpdate)
	return &VendorBalanceCacheUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *VendorBalanceCacheClient) UpdateOne(_m *VendorBalanceCache) *VendorBalanceCacheUpdateOne {
	mutation := newVendorBalanceCacheMutation(c.config, OpUpdateOne, withVendorBalanceCache(_m))
	return &VendorBalanceCacheUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *VendorBalanceCacheClient) UpdateOneID(id uuid.UUID) *VendorBalanceCacheUpdateOne {
	mutation := newVendorBalanceCacheMutation(c.config, OpUpdateOne, withVendorBalanceCacheID(id))
	return &VendorBalanceCacheUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for VendorBalanceCache.
func (c *VendorBalanceCacheClient) Delete() *VendorBalanceCacheDelete {
	mutation := newVendorBalanceCacheMutation(c.config, OpDelete)
	return &VendorBalanceCacheDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *VendorBalanceCacheClient) DeleteOne(_m *VendorBalanceCache) *VendorBalanceCacheDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *VendorBalanceCacheClient) DeleteOneID(id uuid.UUID) *VendorBalanceCacheDeleteOne {
	builder := c.Delete().Where(vendorbalancecache.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &VendorBalanceCacheDeleteOne{builder}
}

// Query returns a query builder for VendorBalanceCache.
func (c *VendorBalanceCacheClient) Query() *VendorBalanceCacheQuery {
	return &VendorBalanceCacheQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeVendorBalanceCache},
		inters: c.Interceptors(),
	}
}

// Get returns a VendorBalanceCache entity by its id.
func (c *VendorBalanceCacheClient) Get(ctx context.Context, id uuid.UUID) (*VendorBalanceCache, error) {
	return c.Query().Where(vendorbalancecache.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *VendorBalanceCacheClient) GetX(ctx context.Context, id uuid.UUID) *VendorBalanceCache {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *VendorBalanceCacheClient) Hooks() []Hook {
	return c.hooks.VendorBalanceCache
}

// Interceptors returns the client interceptors.
func (c *VendorBalanceCacheClient) Interceptors() []Interceptor {
	return c.inters.VendorBalanceCache
}

func (c *VendorBalanceCacheClient) mutate(ctx context.Context, m *VendorBalanceCacheMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&VendorBalanceCacheCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&VendorBalanceCacheUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&VendorBalanceCacheUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&VendorBalanceCacheDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown VendorBalanceCache mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		...
		ServiceDelivery, StockAdjustment, StockBreakdown, StockClearance, StockCount,
		StockCountLine, StockCountTemplate, StockLevelEvent, StockTransfer,
		...
		VariantAttribute, VendorBalanceCache, Warehouse, WarehouseLocation,
		Warranty []ent.Hook
	}
	inters struct {
		ApprovalAction, ApprovalRequest, ApprovalRule, ApprovalStep, Asset, AssetAudit,
