...
const (
	// Label holds the string label denoting the inventoryuser type in the database.
	Label = "inventory_user"
	...
	// Table holds the table name of the inventoryuser in the database.
	Table = "inventory_users"
)

// Columns holds all SQL columns for inventoryuser fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
...
// OrderOption defines the ordering options for the InventoryUser queries.
