...
func (_u *RolePermissionUpdate) SetRole(v *InventoryRole) *RolePermissionUpdate {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the InventoryPermission entity.
func (_u *RolePermissionUpdate) SetPermission(v *InventoryPermission) *RolePermissionUpdate {
...
// SetRole sets the "role" edge to the InventoryRole entity.
func (_u *RolePermissionUpdateOne) SetRole(v *InventoryRole) *RolePermissionUpdateOne {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the InventoryPermission entity.
func (_u *RolePermissionUpdateOne) SetPermission(v *InventoryPermission) *RolePermissionUpdateOne {
	return _u.SetPermissionID(v.ID)
}
