...
func (_c *RolePermissionCreate) SetRole(v *InventoryRole) *RolePermissionCreate {
	return _c.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the InventoryPermission entity.
func (_c *RolePermissionCreate) SetPermission(v *InventoryPermission) *RolePermissionCreate {
