...
func HasRoleWith(preds ...predicate.InventoryRole) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
		step := newRoleStep()
...
func HasPermissionWith(preds ...predicate.InventoryPermission) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
