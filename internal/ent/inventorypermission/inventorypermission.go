...
const (
	// Label holds the string label denoting the inventorypermission type in the database.
	Label = "inventory_permission"
	...
	// Table holds the table name of the inventorypermission in the database.
	Table = "inventory_permissions"
	// RolesTable is the table that holds the roles relation/edge. The primary key declared below.
	RolesTable = "role_permissions"
	// RolesInverseTable is the table name for the InventoryRole entity.
	// It exists in this package in order to avoid circular dependency with the "inventoryrole" package.
	RolesInverseTable = "inventory_roles"
...
// Columns holds all SQL columns for inventorypermission fields.
var Columns = []string{
	FieldID,
	FieldPermissionCode,
	FieldName,
...
// OrderOption defines the ordering options for the InventoryPermission queries.
