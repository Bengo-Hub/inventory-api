...
func (_u *UserRoleAssignmentUpdate) SetUser(v *InventoryUser) *UserRoleAssignmentUpdate {
	return _u.SetUserID(v.ID)
}

// SetRole sets the "role" edge to the InventoryRole entity.
func (_u *UserRoleAssignmentUpdate) SetRole(v *InventoryRole) *UserRoleAssignmentUpdate {
...
// SetUser sets the "user" edge to the InventoryUser entity.
func (_u *UserRoleAssignmentUpdateOne) SetUser(v *InventoryUser) *UserRoleAssignmentUpdateOne {
	return _u.SetUserID(v.ID)
}

// SetRole sets the "role" edge to the InventoryRole entity.
func (_u *UserRoleAssignmentUpdateOne) SetRole(v *InventoryRole) *UserRoleAssignmentUpdateOne {
	return _u.SetRoleID(v.ID)
}
