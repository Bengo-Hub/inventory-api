...
type AuditLog struct {
	...
	// Outlet/warehouse scope of the action, when applicable
	OutletID *uuid.UUID `json:"outlet_id,omitempty"`
	// User who performed the action
	ActorUserID uuid.UUID `json:"actor_user_id,omitempty"`
	// Manager who approved via step-up, when the action required approval
	ApproverUserID *uuid.UUID `json:"approver_user_id,omitempty"`
	// Dotted action code, e.g. stock.adjustment, role.permission_change
	Action string `json:"action,omitempty"`
	// Type of the affected entity, e.g. stock_adjustment, role
	...
	// Monetary or quantity magnitude of the action, when relevant
...
func (*AuditLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case auditlog.FieldOutletID, auditlog.FieldApproverUserID:
