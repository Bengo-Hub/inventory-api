...
type RolePermissionEdges struct {
	...
	Permission *InventoryPermission `json:"permission,omitempty"`
...
func (e RolePermissionEdges) RoleOrErr() (*InventoryRole, error) {
	if e.Role != nil {
		return e.Role, nil
...
// was not loaded in eager-loading, or loaded but was not found.
func (e RolePermissionEdges) PermissionOrErr() (*InventoryPermission, error) {
	if e.Permission != nil {
		return e.Permission, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: inventorypermission.Label}
	}
...
func (_m *RolePermission) QueryRole() *InventoryRoleQuery {
...
func (_m *RolePermission) QueryPermission() *InventoryPermissionQuery {
