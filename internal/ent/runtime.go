...
func init() {
	...
	itemDescTags := itemFields[30].Descriptor()
	...
	itemDescTaxInclusive := itemFields[32].Descriptor()
	...
	itemDescPurchaseUnit := itemFields[36].Descriptor()
	...
	itemDescYieldPct := itemFields[37].Descriptor()
	...
	itemDescBookedCapacity := itemFields[39].Descriptor()
	...
	itemDescEventVenue := itemFields[42].Descriptor()
	...
	itemDescMetadata := itemFields[43].Descriptor()
	...
	itemDescCreatedAt := itemFields[44].Descriptor()
	...
	itemDescUpdatedAt := itemFields[45].Descriptor()
