...
func init() {
	...
	warehouseDescIsDefault := warehouseFields[8].Descriptor()
	...
	warehouseDescIsActive := warehouseFields[9].Descriptor()
	...
	warehouseDescCreatedAt := warehouseFields[10].Descriptor()
	...
	warehouseDescUpdatedAt := warehouseFields[11].Descriptor()
