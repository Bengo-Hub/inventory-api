...
func init() {
	...
	itemDescExtraBedAllowed := itemFields[16].Descriptor()
	...
	itemDescIsActive := itemFields[18].Descriptor()
	...
	itemDescRequiresAgeVerification := itemFields[22].Descriptor()
	...
	itemDescIsControlledSubstance := itemFields[23].Descriptor()
	...
	itemDescIsPerishable := itemFields[24].Descriptor()
	...
	itemDescTrackSerialNumbers := itemFields[25].Descriptor()
	...
	itemDescTrackLots := itemFields[26].Descriptor()
	...
	itemDescTags := itemFields[31].Descriptor()
	...
	itemDescTaxInclusive := itemFields[33].Descriptor()
	...
	itemDescPurchaseUnit := itemFields[37].Descriptor()
	...
	itemDescYieldPct := itemFields[38].Descriptor()
