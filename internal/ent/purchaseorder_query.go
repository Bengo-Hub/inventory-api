...
type PurchaseOrderQuery struct {
	...
	withLines     *PurchaseOrderLineQuery
...
func (_q *PurchaseOrderQuery) QuerySupplier() *SupplierQuery {
...
func (_q *PurchaseOrderQuery) QueryWarehouse() *WarehouseQuery {
...
func (_q *PurchaseOrderQuery) QueryLines() *PurchaseOrderLineQuery {
...
func (_q *PurchaseOrderQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *PurchaseOrderQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *PurchaseOrderQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *PurchaseOrderQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *PurchaseOrderQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *PurchaseOrderQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PurchaseOrderQuery) WithSupplier(opts ...func(*SupplierQuery)) *PurchaseOrderQuery {
	query := (&SupplierClient{config: _q.config}).Query()
...
func (_q *PurchaseOrderQuery) WithWarehouse(opts ...func(*WarehouseQuery)) *PurchaseOrderQuery {
	query := (&WarehouseClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PurchaseOrderQuery) WithLines(opts ...func(*PurchaseOrderLineQuery)) *PurchaseOrderQuery {
	query := (&PurchaseOrderLineClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(purchaseorder.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.PurchaseOrder.Query().
//		Select(purchaseorder.FieldTenantID).
//		Scan(ctx, &v)
...
func (_q *PurchaseOrderQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PurchaseOrder, error) {
	...
	if query := _q.withWarehouse; query != nil {
		if err := _q.loadWarehouse(ctx, query, nodes, nil,
			func(n *PurchaseOrder, e *Warehouse) { n.Edges.Warehouse = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLines; query != nil {
		if err := _q.loadLines(ctx, query, nodes,
			func(n *PurchaseOrder) { n.Edges.Lines = []*PurchaseOrderLine{} },
			func(n *PurchaseOrder, e *PurchaseOrderLine) { n.Edges.Lines = append(n.Edges.Lines, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PurchaseOrderQuery) loadWarehouse(ctx context.Context, query *WarehouseQuery, nodes []*PurchaseOrder, init func(*PurchaseOrder), assign func(*PurchaseOrder, *Warehouse)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*PurchaseOrder)
	for i := range nodes {
...
func (_q *PurchaseOrderQuery) loadLines(ctx context.Context, query *PurchaseOrderLineQuery, nodes []*PurchaseOrder, init func(*PurchaseOrder), assign func(*PurchaseOrder, *PurchaseOrderLine)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(purchaseorderline.FieldPoID)
	}
	query.Where(predicate.PurchaseOrderLine(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(purchaseorder.LinesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "po_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *PurchaseOrderQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(purchaseorder.Table, purchaseorder.Columns, sqlgraph.NewFieldSpec(purchaseorder.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withWarehouse != nil {
			_spec.Node.AddColumnOnce(purchaseorder.FieldWarehouseID)
		}
	}
