...
type RolePermissionQuery struct {
	...
	withRole       *InventoryRoleQuery
	withPermission *InventoryPermissionQuery
...
func (_q *RolePermissionQuery) QueryRole() *InventoryRoleQuery {
...
func (_q *RolePermissionQuery) QueryPermission() *InventoryPermissionQuery {
...
func (_q *RolePermissionQuery) WithRole(opts ...func(*InventoryRoleQuery)) *RolePermissionQuery {
	query := (&InventoryRoleClient{config: _q.config}).Query()
...
func (_q *RolePermissionQuery) WithPermission(opts ...func(*InventoryPermissionQuery)) *RolePermissionQuery {
	query := (&InventoryPermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RolePermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*RolePermission, error) {
	...
	if query := _q.withRole; query != nil {
		if err := _q.loadRole(ctx, query, nodes, nil,
			func(n *RolePermission, e *InventoryRole) { n.Edges.Role = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPermission; query != nil {
		if err := _q.loadPermission(ctx, query, nodes, nil,
			func(n *RolePermission, e *InventoryPermission) { n.Edges.Permission = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RolePermissionQuery) loadRole(ctx context.Context, query *InventoryRoleQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *InventoryRole)) error {
	...
	query.Where(inventoryrole.IDIn(ids...))
...
func (_q *RolePermissionQuery) loadPermission(ctx context.Context, query *InventoryPermissionQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *InventoryPermission)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*RolePermission)
	for i := range nodes {
	...
	query.Where(inventorypermission.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
