...
const (
	// Label holds the string label denoting the inventoryrole type in the database.
	Label = "inventory_role"
	...
	// Table holds the table name of the inventoryrole in the database.
	Table = "inventory_roles"
	...
	// PermissionsInverseTable is the table name for the InventoryPermission entity.
	// It exists in this package in order to avoid circular dependency with the "inventorypermission" package.
	PermissionsInverseTable = "inventory_permissions"
	...
	UserAssignmentsColumn = "inventory_role_user_assignments"
...
// Columns holds all SQL columns for inventoryrole fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldRoleCode,
...
// OrderOption defines the ordering options for the InventoryRole queries.
