...
func (_q *WarehouseQuery) QueryTenant() *TenantQuery {
...
func (_q *WarehouseQuery) QueryBalances() *InventoryBalanceQuery {
...
func (_q *WarehouseQuery) QueryReservations() *ReservationQuery {
	query := (&ReservationClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *WarehouseQuery) WithTenant(opts ...func(*TenantQuery)) *WarehouseQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *WarehouseQuery) WithBalances(opts ...func(*InventoryBalanceQuery)) *WarehouseQuery {
	query := (&InventoryBalanceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *WarehouseQuery) WithReservations(opts ...func(*ReservationQuery)) *WarehouseQuery {
	query := (&ReservationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(warehouse.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Warehouse.Query().
//		Select(warehouse.FieldTenantID).
//		Scan(ctx, &v)
...
func (_q *WarehouseQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Warehouse, error) {
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Warehouse, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withBalances; query != nil {
		if err := _q.loadBalances(ctx, query, nodes,
			func(n *Warehouse) { n.Edges.Balances = []*InventoryBalance{} },
			func(n *Warehouse, e *InventoryBalance) { n.Edges.Balances = append(n.Edges.Balances, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withReservations; query != nil {
...
func (_q *WarehouseQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Warehouse, init func(*Warehouse), assign func(*Warehouse, *Tenant)) error {
...
func (_q *WarehouseQuery) loadBalances(ctx context.Context, query *InventoryBalanceQuery, nodes []*Warehouse, init func(*Warehouse), assign func(*Warehouse, *InventoryBalance)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(inventorybalance.FieldWarehouseID)
	}
	query.Where(predicate.InventoryBalance(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(warehouse.BalancesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *WarehouseQuery) loadReservations(ctx context.Context, query *ReservationQuery, nodes []*Warehouse, init func(*Warehouse), assign func(*Warehouse, *Reservation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Warehouse)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(reservation.FieldWarehouseID)
	}
	query.Where(predicate.Reservation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(warehouse.ReservationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *WarehouseQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTenant != nil {
			_spec.Node.AddColumnOnce(warehouse.FieldTenantID)
		}
	}
