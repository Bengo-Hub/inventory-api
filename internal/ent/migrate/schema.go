		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{ItemsColumns[60]},
				RefColumns: []*schema.Column{UnitsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "items_item_brands_items",
				Columns:    []*schema.Column{ItemsColumns[61]},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ItemsColumns[64], ItemsColumns[1]},
			},
			{
				Name:    "item_tenant_id_category_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[64], ItemsColumns[62]},
			},
			{
				Name:    "item_tenant_id_brand_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[64], ItemsColumns[61]},
			},
			{
				Name:    "item_tenant_id_is_active",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[64], ItemsColumns[28]},
			},
			{
				Name:    "item_tenant_id_barcode",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[64], ItemsColumns[30]},
			},
			{
				Name:    "item_tenant_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[64], ItemsColumns[58]},
			},
			{
				Name:    "item_tenant_id_unit_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[64], ItemsColumns[60]},
			},
			{
				Name:    "item_tenant_id_preferred_supplier_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[64], ItemsColumns[63]},
			},
		},
	}
