		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ItemsColumns[67], ItemsColumns[1]},
			},
			{
				Name:    "item_tenant_id_category_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[67], ItemsColumns[65]},
			},
			{
				Name:    "item_tenant_id_brand_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[67], ItemsColumns[64]},
			},
			{
				Name:    "item_tenant_id_is_active",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[67], ItemsColumns[28]},
			},
			{
				Name:    "item_tenant_id_barcode",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[67], ItemsColumns[30]},
			},
			{
				Name:    "item_tenant_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[67], ItemsColumns[61]},
			},
			{
				Name:    "item_tenant_id_unit_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[67], ItemsColumns[63]},
			},
			{
				Name:    "item_tenant_id_preferred_supplier_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[67], ItemsColumns[66]},
			},
		},
	}
