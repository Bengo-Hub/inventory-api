		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ItemsColumns[72], ItemsColumns[1]},
			},
			{
				Name:    "item_tenant_id_category_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[72], ItemsColumns[70]},
			},
			{
				Name:    "item_tenant_id_brand_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[72], ItemsColumns[69]},
			},
			{
				Name:    "item_tenant_id_is_active",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[72], ItemsColumns[28]},
			},
			{
				Name:    "item_tenant_id_end_of_life_at",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[72], ItemsColumns[64]},
			},
			{
				Name:    "item_tenant_id_barcode",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[72], ItemsColumns[30]},
			},
			{
				Name:    "item_tenant_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[72], ItemsColumns[66]},
			},
			{
				Name:    "item_tenant_id_unit_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[72], ItemsColumns[68]},
			},
			{
				Name:    "item_tenant_id_preferred_supplier_id",
				Unique:  false,
				Columns: []*schema.Column{ItemsColumns[72], ItemsColumns[71]},
			},
		},
	}
