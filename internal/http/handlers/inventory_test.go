...
type mockItemsSvc struct {
	...
	listItemsFn      func(ctx context.Context, tenantID uuid.UUID, typeFilter, statusFilter string, limit, offset int, categoryID *uuid.UUID, unitID *uuid.UUID, search string, tagsFilter ...string) ([]items.ItemDTO, int, error)
...
func (m *mockItemsSvc) ListItems(ctx context.Context, tenantID uuid.UUID, typeFilter, statusFilter string, limit, offset int, categoryID *uuid.UUID, unitID *uuid.UUID, search string, tagsFilter ...string) ([]items.ItemDTO, int, error) {
	if m.listItemsFn != nil {
		return m.listItemsFn(ctx, tenantID, typeFilter, statusFilter, limit, offset, categoryID, unitID, search, tagsFilter...)
	}
