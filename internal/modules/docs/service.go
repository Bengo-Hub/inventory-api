...
// DocumentService is the facade for generating inventory report documents in all formats. It mirrors
// the treasury-api docs.DocumentService: one Generate entry point dispatching by format.
