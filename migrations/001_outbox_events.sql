...
COMMENT ON COLUMN outbox_events.aggregate_type IS 'Entity type: item, warehouse, inventory_balance, etc.';
COMMENT ON COLUMN outbox_events.event_type IS 'Event name: inventory.item.created, inventory.balance.updated, etc.';
